...
export default function CustomizarDocumentacaoPage() {
    return (
        <div className="flex flex-col gap-8 p-4 md:p-8 max-w-[1600px] mx-auto w-full animate-in fade-in duration-300 relative z-10 min-h-screen">
            <header className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <div className="flex items-center gap-3">
                    <div className="px-4 py-2 bg-pink-500/10 border border-pink-500/20 rounded-xl flex items-center gap-3">
                        ...
                        <span className="text-[10px] font-bold text-pink-400 uppercase tracking-widest">Branding Ativo</span>
                    </div>
                </div>
            </header>
