...
export default function AssistentesLayout({ children }: { children: ReactNode }) {
    return (
        <SidebarProvider>
            <AppSidebar />
                ...
                <header className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-4 border-b border-white/5 px-6 backdrop-blur-xl bg-black/60 transition-all">
                    ...
                    <Breadcrumb>
                        <BreadcrumbList>
                            ...
                            <BreadcrumbItem>
                                <BreadcrumbPage className="text-white font-bold tracking-tight">Agente Ajuri X</BreadcrumbPage>
                            </BreadcrumbItem>
                        </BreadcrumbList>
                    </Breadcrumb>
                </header>
                <main className="flex flex-1 flex-col bg-black overflow-x-hidden">
                    {children}
                </main>
            </SidebarInset>
        </SidebarProvider>
